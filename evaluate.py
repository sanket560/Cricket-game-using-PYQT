...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setStyleSheet(": rgb(209, 199, 255);")
        ...
        self.b1.setStyleSheet(": rgb(0, 0, 127);\n"
                              "color: rgb(255, 170, 0);")
        self.b1.setObjectName("b1")
        # calling calculate module to calculate score
    ...
    def retranslateUi(self, Dialog):
        ...
        self.l1.setText(_translate(
            "Dialog", "Evaluate the Performance of your Fantasy Team"))
    ...
    def calculate(self):
        ...
        for i in range(self.list1.count()):
            ...
            # calling batting module
            bat = self.batting(row[1], row[3], row[4], row[2])
            # calling bowling module
            bowl = self.bowling(row[8], row[5], row[7])
